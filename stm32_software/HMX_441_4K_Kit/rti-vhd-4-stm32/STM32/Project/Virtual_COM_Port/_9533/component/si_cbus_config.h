...
//***************************************************************************/
#if !defined __SII_CONFIG_CBUS_H__
#define __SII_CONFIG_CBUS_H__

//------------------------------------------------------------------------------
//  CBUS Component 953x-specific
//------------------------------------------------------------------------------

#define MHL_MAX_CHANNELS    2           // Number of Mhl channels
#define MHL_EXTRA           SI_DISABLE     // extra MHL features
