...
enum
{
    ...
    MHL_MSC_MSG_ACP				= 0x30,		// ACP sub-command
    MHL_MSC_MSG_ACPK			= 0x31,		// ACP Acknowledge sub-command
    MHL_MSC_MSG_ACPE			= 0x32,		// ACP Error sub-command
};
...
enum
{
	MHL_MSC_MSG_ACP_NO_ERROR        		= 0x00,     // ACP No Error
	MHL_MSC_MSG_ACP_INEFFECTIVE_KEY_CODE  	= 0x01,     // The key code in the ACP sub-command is not recognized
	MHL_MSC_MSG_ACP_RESPONDER_BUSY          = 0x02,     // ACP Response busy
};
