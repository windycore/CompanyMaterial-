...
#define NMB_OF_CEA861_VIDEO_MODES   52
#define NMB_OF_HDMI_VIDEO_MODES     4
#define NMB_OF_PC_VIDEO_MODES       36
#define NMB_OF_VIDEO_MODES          (NMB_OF_CEA861_VIDEO_MODES + NMB_OF_HDMI_VIDEO_MODES + NMB_OF_PC_VIDEO_MODES)
...
uint8_t             SiiVideoTableRepetitionGet(uint8_t video_idx);
