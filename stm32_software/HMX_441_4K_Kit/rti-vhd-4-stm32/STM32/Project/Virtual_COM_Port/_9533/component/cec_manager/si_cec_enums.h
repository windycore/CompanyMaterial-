//***************************************************************************
//!file     si_cec_enums.h
//!brief    CEC Spec v1.3a/v1.4 command and operand codes.
//
...
typedef enum _SiiCecOpcodes_t       // CEC Messages
    ...
    CECOP_GIVE_PHYSICAL_ADDRESS     = 0x83, // A request to a device to return its Physical Address.
    CECOP_REPORT_PHYSICAL_ADDRESS   = 0x84,// Used to inform all other devices of the mapping between physical and Logical Address of the Initiator.
