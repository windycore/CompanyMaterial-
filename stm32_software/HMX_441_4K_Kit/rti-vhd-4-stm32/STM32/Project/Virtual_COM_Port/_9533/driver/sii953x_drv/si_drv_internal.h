...
//!brief    Sii9535 driver internal header.
...
#ifndef __SI_IDRV_SII9535_H__
#define __SI_IDRV_SII9535_H__
#include "si_common.h"
#include "si_cra.h"
...
extern DeviceDrvInstanceData_t deviceDrvInstance[INSTANCE_9533];
...
//------------------------------------------------------------------------------
//  Device Component SiI9535-specific
//------------------------------------------------------------------------------
...
uint8_t SiiRegRead(BYTE cInstance,  uint16_t regAddr );
void    SiiRegWrite( BYTE cInstance,  uint16_t regAddr, uint8_t wrData );
void    SiiRegModify( BYTE cInstance, uint16_t regAddr, uint8_t mask, uint8_t value );
void    SiiRegReadBlock( BYTE cInstance, uint16_t regAddr, uint8_t *pData, uint16_t count );
void    SiiRegWriteBlock( BYTE cInstance, uint16_t regAddr, uint8_t *pData, uint16_t count );
void    SiiRegSetNewBits( BYTE cInstance, uint16_t regAddr, uint8_t bits, bool_t setBits );
