...
//#define MACHINETYPE   MUH4K862//MUH88E_BYE
#define MACHINETYPE   MHUB4K431//MUH88E_BYE

#define MODIFY_IR_SWITCH_2017_2_21 //修改红外切换方式，先按输出(对应的那一组灯闪烁)，再按输入就直接切换

#ifndef MACHINETYPE
#define MACHINETYPE   MODETYPE_NONE
#endif
...
#define INSTANCE_9679  8
#define ADN4604_NUM_INSTANCES 2
#define PCA9539_NUM_INSTANCES   3
#define AT24CM01_1024
#define PRD_POWER_ONOFF_MESSAGE
#define PRD_IR_OUT  1
#define TM1623_INSTANCES   2
#ifdef MODIFY_IR_SWITCH_2017_2_21
#define g_FW_Version  "V1.0.5"
#define TEST_FW_Version  "V1.0.5"
#else
#define g_FW_Version  "V1.0.3"
#define TEST_FW_Version  "V1.0.3"
#endif
#define ENABLE_DB9_BAUDRATE_SWITCH
#elif (MACHINETYPE==MHUB4K431)
#define INSTANCE_9533   2   // 9533 incstance
#define INSTANCE_9679   2
#define ADN4604_NUM_INSTANCES   1
#define PCA9539_NUM_INSTANCES   2
//#define NV24LC32A
#define AT24CM01_1024
...
#define DevNum   INSTANCE_9533    // 9533 incstance

#define		INC_ARC 	 		0

#if (MACHINETYPE==MUH88E_BYE||MACHINETYPE==PRD_VHD4||(MACHINETYPE==MUH4K862)||(MACHINETYPE==MHUB4K431))
#define		INC_CEC 			1
...
// 1HZ = 1s
// 1000 HZ = 1ms
#define TICK_TIME_mS   (1000u/OS_CFG_TICK_RATE_HZ)  // 一个TICK 多少ms
