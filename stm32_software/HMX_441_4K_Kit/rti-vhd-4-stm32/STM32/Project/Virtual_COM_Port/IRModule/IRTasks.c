 ...
 * CONFIGURATION: Key event lookup table for infrared remote */
	...
	{0x1C, KEY_PRESS, ke1TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x1D, KEY_PRESS, ke1TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x79, KEY_PRESS, ke1TO5,   	keNONE, keNONE, keNONE, 0, 0},
	{0x7A, KEY_PRESS, ke1TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x21, KEY_PRESS, ke1TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x23, KEY_PRESS, ke1TO8,   	keNONE, keNONE, keNONE, 0, 0},
	
	{0x24, KEY_PRESS, ke2TO1,   	keNONE, keNONE, keNONE, 0, 0},
	{0x25, KEY_PRESS, ke2TO2,   	keNONE, keNONE, keNONE, 0, 0},
	{0x26, KEY_PRESS, ke2TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x27, KEY_PRESS, ke2TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x28, KEY_PRESS, ke2TO5,   	keNONE, keNONE, keNONE, 0, 0},
	{0x29, KEY_PRESS, ke2TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x2B, KEY_PRESS, ke2TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x2C, KEY_PRESS, ke2TO8,   	keNONE, keNONE, keNONE, 0, 0},
	
	{0x2D, KEY_PRESS, ke3TO1,   	keNONE, keNONE, keNONE, 0, 0},
	{0x2E, KEY_PRESS, ke3TO2,   	keNONE, keNONE, keNONE, 0, 0},
	{0x2F, KEY_PRESS, ke3TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x30, KEY_PRESS, ke3TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x31, KEY_PRESS, ke3TO5,   	keNONE, keNONE, keNONE, 0, 0},
	{0x32, KEY_PRESS, ke3TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x33, KEY_PRESS, ke3TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x34, KEY_PRESS, ke3TO8,   	keNONE, keNONE, keNONE, 0, 0},
	...
	{0x37, KEY_PRESS, ke4TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x38, KEY_PRESS, ke4TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x39, KEY_PRESS, ke4TO5,   	keNONE, keNONE, keNONE, 0, 0},
	{0x3A, KEY_PRESS, ke4TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x3B, KEY_PRESS, ke4TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x3D, KEY_PRESS, ke4TO8,   	keNONE, keNONE, keNONE, 0, 0},

	{0x3E, KEY_PRESS, ke5TO1,   	keNONE, keNONE, keNONE, 0, 0},
	{0x3F, KEY_PRESS, ke5TO2,   	keNONE, keNONE, keNONE, 0, 0},
	{0x7E, KEY_PRESS, ke5TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x7D, KEY_PRESS, ke5TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x8F, KEY_PRESS, ke5TO5,   	keNONE, keNONE, keNONE, 0, 0},//0x7f会串码
	{0x81, KEY_PRESS, ke5TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x7B, KEY_PRESS, ke5TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x7C, KEY_PRESS, ke5TO8,   	keNONE, keNONE, keNONE, 0, 0},

	{0x83, KEY_PRESS, ke6TO1,   	keNONE, keNONE, keNONE, 0, 0},
	{0x85, KEY_PRESS, ke6TO2,   	keNONE, keNONE, keNONE, 0, 0},
	{0x4A, KEY_PRESS, ke6TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x4B, KEY_PRESS, ke6TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x84, KEY_PRESS, ke6TO5,   	keNONE, keNONE, keNONE, 0, 0},
	{0x86, KEY_PRESS, ke6TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x4E, KEY_PRESS, ke6TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x4F, KEY_PRESS, ke6TO8,   	keNONE, keNONE, keNONE, 0, 0},

	{0x8C, KEY_PRESS, ke7TO1,   	keNONE, keNONE, keNONE, 0, 0},
	{0x71, KEY_PRESS, ke7TO2,   	keNONE, keNONE, keNONE, 0, 0},
	{0x53, KEY_PRESS, ke7TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x8B, KEY_PRESS, ke7TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x72, KEY_PRESS, ke7TO5,   	keNONE, keNONE, keNONE, 0, 0},
	{0x56, KEY_PRESS, ke7TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x57, KEY_PRESS, ke7TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x89, KEY_PRESS, ke7TO8,   	keNONE, keNONE, keNONE, 0, 0},

	{0x8A, KEY_PRESS, ke8TO1,   	keNONE, keNONE, keNONE, 0, 0},
	{0x5B, KEY_PRESS, ke8TO2,   	keNONE, keNONE, keNONE, 0, 0},
	{0x87, KEY_PRESS, ke8TO3,	    keNONE, keNONE, keNONE, 0, 0},
	{0x88, KEY_PRESS, ke8TO4,   	keNONE, keNONE, keNONE, 0, 0},
	{0x5E, KEY_PRESS, ke8TO5,   	keNONE, keNONE, keNONE, 0, 0},
	{0x5F, KEY_PRESS, ke8TO6,   	keNONE, keNONE, keNONE, 0, 0},
	{0x61, KEY_PRESS, ke8TO7,	    keNONE, keNONE, keNONE, 0, 0},
	{0x63, KEY_PRESS, ke8TO8,   	keNONE, keNONE, keNONE, 0, 0},
	...
	{0x74, KEY_PRESS, ke3TOALL,	    keNONE, keNONE, keNONE, 0, 0},
	{0x73, KEY_PRESS, ke4TOALL,   	keNONE, keNONE, keNONE, 0, 0},
	{0x14, KEY_PRESS, ke5TOALL,   	keNONE, keNONE, keNONE, 0, 0},
	{0x18, KEY_PRESS, ke6TOALL,   	keNONE, keNONE, keNONE, 0, 0},
	{0x76, KEY_PRESS, ke7TOALL,	    keNONE, keNONE, keNONE, 0, 0},
	{0x77, KEY_PRESS, ke8TOALL,   	keNONE, keNONE, keNONE, 0, 0},
#endif
/* ---------------------------- END CUSTOM AREA --------------------------- */
};
...
bool_t halIRKeyProcess (void)
{
    ...
    #if 0
    if(wKeycode!=m_wLastIRKey)
    {
        Uart_printf("IRKey===0x%02x\n",IRKey);
    }
    #endif
